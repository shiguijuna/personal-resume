...
const relatedProject = getProjectBySlug(post.projectSlug)
...
useSeoMeta({
  title: `${post.title} | shiguijun 博客`,
  description: post.desc,
  keywords: ['shiguijun', post.title, ...post.tags].join(','),
})
</script>
  ...
  <div class="blog-page">
    <main id="main-content" class="blog-shell">
      <nav class="breadcrumb" aria-label="面包屑导航">
        ...
        <span>/</span>
        <NuxtLink to="/#blog">博客精选</NuxtLink>
        <span>/</span>
      ...
      <div class="article-layout">
        ...
        <aside class="article-side">
          ...
          <div v-if="relatedProject" class="side-block">
            ...
            <NuxtLink :to="`/projects/${relatedProject.slug}`">查看项目详情</NuxtLink>
          </div>
        </aside>
      </div>

      <div class="article-actions">
        <NuxtLink class="outline-action" to="/#blog">返回博客精选</NuxtLink>
        <NuxtLink v-if="nextPost" class="primary-action" :to="`/blog/${nextPost.slug}`">
