...
useSeoMeta({
  title: '博客文章 | shiguijun',
  description: 'shiguijun 的前端实践博客，涵盖 Vue、小程序、中后台系统、数据可视化等项目的复盘与技术分享。',
  keywords: 'shiguijun,前端博客,Vue,小程序,uni-app,中后台,ECharts,技术复盘',
        ...
        <div v-else class="listing-grid">
          ...
          >
            <div class="post-cover">
              <NuxtImg :src="post.image" :alt="`${post.projectTitle} 文章封面`" loading="lazy" format="webp" width="400" height="190" sizes="sm:100vw md:400px" />
