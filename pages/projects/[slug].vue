...
const relatedPost = getPostByProjectSlug(project.slug)

useSeoMeta({
  title: `${project.title} | shiguijun 项目经历`,
  description: project.desc,
  keywords: ['shiguijun', project.title, ...project.tags].join(','),
})
</script>
  ...
  <div class="project-page">
    <main id="main-content" class="project-shell">
      <nav class="breadcrumb" aria-label="面包屑导航">
        ...
        <span>/</span>
        <NuxtLink to="/#projects">项目经历</NuxtLink>
        <span>/</span>
      ...
      <div class="detail-layout">
        ...
        <aside class="summary-card">
          ...
          <div v-if="relatedPost" class="summary-block">
            ...
            <NuxtLink :to="`/blog/${relatedPost.slug}`">阅读技术文章</NuxtLink>
          </div>
        </aside>
      </div>

      <div class="detail-actions">
        <NuxtLink class="outline-action" to="/#projects">返回项目列表</NuxtLink>
        <NuxtLink v-if="nextProject" class="primary-action" :to="`/projects/${nextProject.slug}`">
          查看下一个项目
        </NuxtLink>
      </div>
    </main>
